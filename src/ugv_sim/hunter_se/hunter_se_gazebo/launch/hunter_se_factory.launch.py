...
def generate_launch_description():
    ...
    gazebo_world_path = os.path.join(
        get_package_share_directory('hunter_se_gazebo'), 'world', 'factory.world')
    ...
    # Launch Gazebo with factory world
    ...
    # RViz2 configuration file path for factory environment
    rviz_config_path = os.path.join(
        get_package_share_directory('hunter_se_description'),
        'rviz',
        'hunter_se_factory.rviz'
    )

    # Launch RViz2 with factory configuration
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
